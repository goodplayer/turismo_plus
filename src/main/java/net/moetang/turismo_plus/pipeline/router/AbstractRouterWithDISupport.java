 ...
 *
 */
public abstract class AbstractRouterWithDISupport implements Router {
	public AbstractRouterWithDISupport() {
		map();
		makeResolver();
	}
	...
	protected final void _custom(final String method, final String path, final Condition[] conditions, IAction action, final String actionName) {
		if (this.resolver == null) {
	...
	protected final void _default(final String actionName){
		if (this.resolver == null) {
			this.defaultAction = this.getAction(actionName);
		}
	}
	//===============================================
	...
	protected final void get(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(GET, path, conditions, action, actionName);
    }
	protected final void post(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(POST, path, conditions, action, actionName);
    }
	protected final void put(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(PUT, path, conditions, action, actionName);
    }
	protected final void head(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(HEAD, path, conditions, action, actionName);
    }
	protected final void options(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(OPTIONS, path, conditions, action, actionName);
    }
	protected final void delete(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(DELETE, path, conditions, action, actionName);
    }
	protected final void trace(final String path, final Condition[] conditions, final IAction action, final String actionName) {
		_custom(TRACE, path, conditions, action, actionName);
    }
    // Shortcuts methods
	protected final void get(final String path, final IAction action, final String actionName) {
		get(path, new Condition[0], action, actionName);
    }
	protected final void post(final String path, final IAction action, final String actionName) {
		post(path, new Condition[0], action, actionName);
    }
	protected final void put(final String path, final IAction action, final String actionName) {
		put(path, new Condition[0], action, actionName);
    }
	protected final void head(final String path, final IAction action, final String actionName) {
		head(path, new Condition[0], action, actionName);
    }
	protected final void options(final String path, final IAction action, final String actionName) {
		options(path, new Condition[0], action, actionName);
    }
	protected final void delete(final String path, final IAction action, final String actionName) {
		delete(path, new Condition[0], action, actionName);
    }
	protected final void trace(final String path, final IAction action, final String actionName) {
		trace(path, new Condition[0], action, actionName);
    }
	protected final void _custom(final String method, final String path, final IAction action, final String actionName){
		_custom(method, path, new Condition[0], action, actionName);
	}
